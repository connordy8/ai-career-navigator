    ...
    programs: [
      {
        ...
        description: "Learn IT support fundamentals with career coaching, mentorship, and CompTIA A+ cert prep. Nothing to pay upfront — payment begins 3+ months after you complete or exit, with options to defer if not yet earning $40k.",
        isFeatured: true,
      },
      {
        id: "ps-it",
    ...
    programs: [
      {
        ...
        cost: "No upfront cost",
        format: "Online, live sessions",
        description: "Learn data analytics with Excel, SQL, Tableau, and Python basics. Includes career coaching and job placement support. Nothing to pay upfront — payment begins 3+ months after you complete or exit, with options to defer if not yet earning $40k.",
        isFeatured: true,
      },
      {
        id: "google-data",
    ...
    programs: [
      {
        ...
        cost: "No upfront cost",
        format: "Online, live sessions",
        description: "Learn Java programming from scratch. Build real projects with career coaching and job placement support. Nothing to pay upfront — payment begins 3+ months after you complete or exit, with options to defer if not yet earning $40k.",
        isFeatured: true,
      },
      {
        id: "fcc-web",
